...
/* package math-prelude-0.2.0.0 */
#define VERSION_math_prelude "0.2.0.0"
#define MIN_VERSION_math_prelude(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
...
#define CURRENT_PACKAGE_KEY "mathg_AuUe5HYrrH34wvGK09tU5A"
